...
guest_train_data = {"name": "vmd_guest", "namespace": "experiment"}
host_train_data = {"name": "vmd_host2", "namespace": "experiment"}

guest_eval_data = {"name": "vmd_guest", "namespace": "experiment"}
host_eval_data = {"name": "vmd_host2", "namespace": "experiment"}
...
# hetero_secureboost_0._module_name = "HeteroLR1"
# add components to pipeline, in order of task execution
pipeline.add_component(reader_0)
pipeline.add_component(data_transform_0, data=Data(data=reader_0.output.data))
# set data input sources of intersection components
pipeline.add_component(intersection_0, data=Data(data=data_transform_0.output.data))
# set train data of hetero_secureboost_0 component
...
predict_pipeline.add_component(evaluation_0, data=Data(data=pipeline.hetero_secureboost_0.output.data))
# run predict model
