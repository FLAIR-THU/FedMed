...
guest_train_data = {"name": "vmd_guest_full", "namespace": "experiment"}
host_train_data = {"name": "vmd_host2", "namespace": "experiment"} #host方数据
# host_train_data = {"name": "vmd_null_host", "namespace": "experiment"} #空的host方数据

guest_eval_data = {"name": "vmd_guest_full", "namespace": "experiment"}
host_eval_data = {"name": "vmd_host2", "namespace": "experiment"} #host方数据
# host_eval_data = {"name": "vmd_null_host", "namespace": "experiment"} #空的host方数据
...
hetero_lr_0.get_party_instance(role="host", party_id=host).component_param(need_run=False)
# hetero_lr_0._module_name = "HeteroLR1"
