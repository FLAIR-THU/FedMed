...
def read_data(fate_home):
    # config_file = os.path.join(fate_home, "data/my_data_config.json")
    # config_file = os.path.join(fate_home, "data/psi_testsuite.json")
    # config_file = os.path.join(fate_home, "data/homo_nn_testsuite.json")
    config_file = os.path.join(fate_home, "data/data_transform_testsuite.json")
    config_file = os.path.join(fate_home, "data/zs_data.json")
    config_file = os.path.join(fate_home, "data/hetero_poisson_testsuite.json")
    config_file = os.path.join(fate_home, "data/my_data_config.json")
...
def main():
    ...
    upload_data = read_data(cur_path)
