...
secure_add_example_cpn_meta = ComponentMeta("SecureVecMultExample")
...
def secure_add_example_param():
    ...
    return SecureVecMultExampleParam


@secure_add_example_cpn_meta.bind_runner.on_guest
def secure_add_example_guest_runner():
    from federatedml.toy_example.secure_vec_mult_guest import SecureVecMultGuest

    return SecureVecMultGuest


@secure_add_example_cpn_meta.bind_runner.on_host
def secure_add_example_host_runner():
    from federatedml.toy_example.secure_vec_mult_host import SecureVecMultHost

    return SecureVecMultHost
